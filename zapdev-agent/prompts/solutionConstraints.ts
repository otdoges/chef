...
function templateInfo() {
  return stripIndents`
  <template_info>
    The Zapdev WebContainer environment starts with a full-stack app template fully loaded at '/home/project',
    ...
    <file path="convex/auth.ts">
      ...
      within Zapdev. They can download the code and do it themselves.
