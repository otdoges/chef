...
import { presenceComponentReadmePrompt } from 'zapdev-agent/prompts/components/presence';
import { proseMirrorComponentReadmePrompt } from 'zapdev-agent/prompts/components/proseMirror';
import { z } from 'zod';
import { resendComponentReadmePrompt } from 'zapdev-agent/prompts/components/resend';
