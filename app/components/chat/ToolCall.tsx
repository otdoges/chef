...
import { loggingSafeParse } from 'zapdev-agent/utils/zodUtil';
import { deployToolParameters } from 'zapdev-agent/tools/deploy';
...
import { lookupDocsParameters } from 'zapdev-agent/tools/lookupDocs';
...
const ToolUseContents = memo(function ToolUseContents({
  ...
  switch (invocation.toolName) {
    ...
    case 'firecrawl': {
      return <FirecrawlTool invocation={invocation} />;
    }
