...
export function ApiKeyCard() {
  ...
  const hasAnyKey = apiKey && (apiKey.value || apiKey.openai || apiKey.openrouter || apiKey.xai || apiKey.google);
    ...
    <div className="rounded-lg border bg-bolt-elements-background-depth-1 shadow-sm">
      <div className="p-6">
        ...
        <p className="mb-1 max-w-prose text-sm text-content-secondary">
          You can use your own API keys to build with ZapDev.
        </p>
        <p className="mb-4 max-w-prose text-sm text-content-secondary">
          By default, ZapDev will use tokens built into your Convex plan.
        </p>
...
type KeyType = 'anthropic' | 'google' | 'openai' | 'openrouter' | 'xai';
